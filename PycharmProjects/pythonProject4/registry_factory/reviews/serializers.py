...
from .models import Review, meta_default_value, get_next_internal_id


class ReviewsBulkSerializer(serializers.ListSerializer):
    ...
    def create(self, validated_data):
        ...
        for item in validated_data:
            ...
            item.pop("meta")
            object_data.append(Review(meta=meta_data, **item))

        return Review.objects.bulk_create(object_data)
...
class ReviewSerializer(serializers.ModelSerializer):
    id = serializers.UUIDField(validators=[UniqueValidator(queryset=Review.objects.all())],
                               allow_null=True)
    ...
    def create(self, validated_data):
        ...
        instance = Review.objects.create(meta=meta_data, **validated_data)
    ...
    class Meta:
        ...
        list_serializer_class = ReviewsBulkSerializer

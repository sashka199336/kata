...
from .filters import ReviewFilter, DynamicSearchFilter, CustomizedOrdering


@extend_schema(tags=['Reviews controllers'])
class ReviewsViewset(mixins.ListModelMixin,
    ...
    @extend_schema(
        ...
        examples=[
            OpenApiExample(
                ...
                value=reviews_list_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_bulk_create_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk create response example',
                value=reviews_bulk_create_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_bulk_put_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk put response example',
                value=reviews_bulk_put_response_example,
                response_only=True,
            )
        ]
    )
    def bulk_update(self, request, *args, **kwargs):
        ...
        instances = Review.objects.filter(id__in=ids).order_by('id')  # We only take instances that need to be updated
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_bulk_patch_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} bulk patch response example',
                value=reviews_bulk_patch_response_example,
                response_only=True,
            )
        ]
    )
    ...
    def bulk_deactivate(self, request, *args, **kwargs):
        ...
        objs = Review.objects.filter(id__in=id_list)
        ...
        if len(id_list) == len(objs):
            ...
            return Response(data={"message": f"{len(objs)} reviews deactivated out of {len(id_list)}. "
...
@extend_schema(tags=['Review controllers'])
class ReviewViewset(mixins.RetrieveModelMixin,
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_single_retrieve_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_single_put_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single put response example',
                value=reviews_single_put_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @ extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_single_create_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single create response example',
                value=reviews_single_create_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(
        examples=[
            OpenApiExample(
                ...
                value=reviews_single_patch_request_example,
                request_only=True,
            ),
            OpenApiExample(
                name=f'{capitalized_app_name} single patch response example',
                value=reviews_single_patch_response_example,
                response_only=True,
            )
        ]
    )
    ...
    @extend_schema(responses={
            200: OpenApiResponse(
                inline_serializer(
                    name='ReviewDeactivatedResponse',
                    fields={
                        'message': serializers.CharField(default="Review deactivated"),
                    }
                ),
                description="Deactivated",
            )
    ...
    def deactivate(self, request, *args, **kwargs):
        ...
        instance.save()
        return Response(data={"message": "Review deactivated"},
                        status=status.HTTP_200_OK)
